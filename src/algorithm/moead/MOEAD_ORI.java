 ...
 *
 */
public class MOEAD_ORI extends Algorithm {

    public MOEAD_ORI() {
        algorithmName = "MOEAD";
    }

    public MOEAD_ORI(String name) {
        super();
    }
    ...
    public static void main(String[] args) {
        MOEAD_ORI moead3 = new MOEAD_ORI();
        Problem problem = new ZDT1();
        Decomposition decomposition = new Tchebycheff();
        moead3.setProblem(problem);
        moead3.setDecomposition(decomposition);
        moead3.setH(99);
        moead3.setNeiboringNum(20);
        moead3.init();
        moead3.evoluation();
        moead3.print();
    }
